                                    ...
                                    <table class="table table-striped table-hover" style="font-size: larger">
                                        <tbody><tr>
                                                <td>  Procurement Guidelines 2006 Goods and Works <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>

                                            </tr>
                                            <tr>
                                                <td>  Procurement Manual 2006 <i class="fa fa-arrow-right" aria-hidden="true"></i> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
                                            <tr>
                                                <td> Guide to project management &amp; contract management for infrastructure development projects (Works)  <i class="fa fa-arrow-right" aria-hidden="true"></i> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
                                            <tr>
                                                <td>  Selection &amp; Employment Of Consultants <i class="fa fa-arrow-right" aria-hidden="true"></i><button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
                                            <tr>
                                                <td> Consulting services manual- November 2007   <i class="fa fa-arrow-right" aria-hidden="true"></i> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
                                            <tr>
                                                <td>  Guidelines on Private Sector Infrastructure Projects (Government Tender Procedure - Part II) <i class="fa fa-arrow-right" aria-hidden="true"></i> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
                                            <tr>
                                                <td> <a href="https://www.treasury.gov.lk/web/procurement-guidelines-and-manuals/section/guidelines%20for%20procurement%20of%20pharmaceuticals%20and%20medical%20devices%20-%202006"> Guidelines for Procurement of Pharmaceuticals &amp; Medical Devices - 2022 <i class="fa fa-arrow-right" aria-hidden="true"></i> </a> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>              </tr>
                                            <tr>
                                                <td> Bidder's guide to success in public procurement archive of NPA publications <i class="fa fa-arrow-right" aria-hidden="true"></i> <button type="button" class="btn btn-outline-dark btn-sm"><i class="bi bi-download"></i> Download </button></td>
                                            </tr>
