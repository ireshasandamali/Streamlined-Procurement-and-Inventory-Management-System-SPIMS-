        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center justify-content-between">
                   ...
                   <span class="d-none d-lg-block" style="color: #0d6efd !important; font-family: 'Arial', sans-serif; font-size: 24px;">SPIMS</span>
                    </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        ...
                        <h2>Gain transparency of the purchasing through the full automation of the procurement process. Streamlined approvals, smart budgeting and expense tracking, automated PR and PO processing all in one app.</h2>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        ...
                        <!--  <div class="col-lg-6 order-1 order-lg-2 hero-img">
                         <img src="<?= base_url('public/assets_web/img/carousel/procurement 04.jpg') ?>" class="img-fluid" alt="">
                       </div>-->
                    </div>
                </div>
                    ...
                    <div class="row">
                         <div class="col-lg-3 col-md-6 mb-4">
                            <div class="icon-box" style="background-color: #cc8800; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/invitation.jpg') ?>" class="img-fluid mx-auto d-block" alt="">                                                              
                                <h4 class="title"> <a href="<?= site_url('web/newBid/' . $list[0]['id']) ?>">INVITATION FOR BIDS</a></h4>
                         ...
                         <div class="col-lg-3 col-md-6 mb-4">
                            <div class="icon-box" style="background-color: #99ff66; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/procurementplan.jpg') ?>" class="img-fluid mx-auto d-block" alt=""> 
                        ...
                        <div class="col-lg-3 col-md-6 mb-4" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color: #ffff99; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/vote.png') ?>" class="img-fluid mx-auto d-block" alt=""> 
                         ...
                         <div class="col-lg-3 col-md-6 mb-4" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color:  #00e6e6; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/request.jpg') ?>" class="img-fluid mx-auto d-block" alt=""> 
                        ...
                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #ffff4d; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/procurementmanagement.jpg') ?>" class="img-fluid mx-auto d-block" alt=""> 
                        ...
                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #00b33c; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/inventory4.jpg') ?>" class="img-fluid mx-auto d-block" alt=""> 
                        ...
                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #b36b00; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/spesification.jpg') ?>" class="img-fluid mx-auto d-block" alt=""> 
                                <div class="icon"><i class="bi bi-clock" style="color: #4680ff;"></i></div>
      ...
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center aos-init aos-animate" data-aos="fade-right" data-aos-delay="100">
            <img src="public/assets_web/img/skills.png" class="img-fluid" alt="">
          </div>
                ...
                <div class="container">
                    ...
                    <div class="row counters position-relative">
                        ...
                        <div class="col-lg-3 col-6 text-center">
                            ...
                            <p>New Procurement Announcement</p>
                        </div>

                        <div class="col-lg-3 col-6 text-center">
                            <span data-purecounter-start="0" data-purecounter-end="1463" data-purecounter-duration="1" class="purecounter"></span>
                            <p>Active Procurement Announcement</p>
                        </div>
                        ...
                        <div class="card-group">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> Now you can enjoy your </p>
                                    <a href="<?= site_url('web/registeredSupplier')?>">Register</a>
                                </div>
                            ...
                            <div class="row portfolio-container">
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-1.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>App 1</h4>
                                    <p>App</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-1.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-2.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Web 3</h4>
                                    <p>Web</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-2.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-3.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>App 2</h4>
                                    <p>App</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-3.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-4.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Card 2</h4>
                                    <p>Card</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-4.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 2"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-5.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Web 2</h4>
                                    <p>Web</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-5.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-6.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>App 3</h4>
                                    <p>App</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-6.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 3"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-7.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Card 1</h4>
                                    <p>Card</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-7.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 1"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-8.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Card 3</h4>
                                    <p>Card</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-8.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 3"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                <div class="portfolio-wrap">
                                  <img src="<?= base_url('public/assets_web/img/portfolio/portfolio-9.jpg') ?>" class="img-fluid" alt="">
                                  <div class="portfolio-info">
                                    <h4>Web 3</h4>
                                    <p>Web</p>
                                    <div class="portfolio-links">
                                      <a href="<?= base_url('public/assets_web/img/portfolio/portfolio-9.jpg') ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                                      <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                                    </div>
                                  </div>
                                </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-item">
                                                    <img src="<?= base_url('public/assets_web/img/testimonials/testimonials-1.jpg') ?>" class="testimonial-img" alt="">
                                                    <h3>Saul Goodman</h3>
                                                    <h4>Ceo &amp; Founder</h4>
                                                    <p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-item">
                                                    <img src="<?= base_url('public/assets_web/img/testimonials/testimonials-2.jpg') ?>" class="testimonial-img" alt="">
                                                    <h3>Sara Wilsson</h3>
                                                    <h4>Designer</h4>
                                                    <p>
                                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-item">
                                                    <img src="<?= base_url('public/assets_web/img/testimonials/testimonials-3.jpg') ?>" class="testimonial-img" alt="">
                                                    <h3>Jena Karlis</h3>
                                                    <h4>Store Owner</h4>
                                                    <p>
                                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-item">
                                                    <img src="<?= base_url('public/assets_web/img/testimonials/testimonials-4.jpg') ?>" class="testimonial-img" alt="">
                                                    <h3>Matt Brandon</h3>
                                                    <h4>Freelancer</h4>
                                                    <p>
                                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-item">
                                                    <img src="<?= base_url('public/assets_web/img/testimonials/testimonials-5.jpg') ?>" class="testimonial-img" alt="">
                                                    <h3>John Larson</h3>
                                                    <h4>Entrepreneur</h4>
                                                    <p>
                                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 footer-contact">
                                                ...
                                                <p>
                                                    ...
                                                    <strong>Email:</strong> STFProcurement@gmail.com<br>
                                                </p>
                                            </div>
