...
<section id="services" class="services section-bg">
    <div class="container">
        ...
        <div class="section-title">
            ...
            <p style="font-family: 'Bolt'">Effectively managing purchase requests is essential for maintaining a well-organised procurement process, controlling expenses, and ensuring timely delivery of goods and services. It also aids in optimising the organisation’s spending, preventing unnecessary or duplicate purchases, and adhering to budgetary constraints.</p>
        
        </div>

        <div class="card">
            <div class="card-header" style="background-color: #0040ff; color: white;">
              Purchase Request
            </div>
            <div class="card-body">
                <h5 class="card-title"></h5>
                <p class="card-text">The purchase order request form serves as an internal too enabling employees to formally request the acquisition of items or services required for various purposes, ranging from essential office supplies and inventory replenishment to crucial manufacturing inputs necessary for ongoing operations of all STF camps.</p>
               ...
               <!--  <ul class="nav nav-tabs">
                    <li><a href="#new" data-toggle="tab">New Notices &nbsp; <span class="label label-primary pull-right">56</span> </a></li>
                    <li class="active"><a href="#active" data-toggle="tab">Active Notices &nbsp;  <span class="label label-success pull-right"> 168 </span> </a></li>
                    <li><a href="#emergency" data-toggle="tab">Emergency Notices &nbsp;  <span class="label label-danger pull-right"> 17 </span> </a></li>
                    <li><a href="#expired" data-toggle="tab">Expired Notices &nbsp;  <span class="label label-warning pull-right"> 6632 </span> </a></li>

                </ul> -->
              <!-- Table Variants -->

                    
                 <table class="table table-success table-striped" style="margin-left: 2px; margin-right: 2px;">
                ...
                <tbody  style="vertical-align: middle;">
                  ...
                  <tr>
                    ...
                    <td><?= $result['CName'] ?></td>
                    <td style="font-size: 12px;"><?= $result['ReqDate'] ?></td>
                    <td></td>
