...
<section id="services" class="services section-bg">
    <div class="container">
        ...
        <div class="section-title">
            <h2>VOTE ALLOCATION</h2>
            <p style="font-family: 'TSG Bolt', 'Ittali'; color: #000080;font-size: 22px;">Basis of Accounting</p>
            <p style="font-family: 'Bolt'">Project Management Units and implementing agencies must maintain proper accounting documents for their
                transactions. Department of State Accounts Circular No. 2002/149 of 27 June 2002 (Guidelines and Procedures and
                Monitoring Systems on the Use of Asian Development Bank’s Imprest Fund Procedure)
                gives specific instructions to Project Management Units and implementing agencies regarding the proper
                maintenance of the following vote allocations for the advance account</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6" data-wow-delay="0.1s">
                            <div class="icon-box">
                                ...
                                <h4 class="title"><a href=""><?= $result['Vote'] ?></a></h4>
                                <p class="description" style="font-family: 'TSG Bolt', 'Ittali'; color: #000080;font-size: 16px;"><?= $result['Description'] ?></p>
                                <p class="description" style="font-family: 'TSG Bolt', 'Ittali'; color: #00004d; font-size: 18px;">Allocation RS. <?= $result['Allocation'] ?></p>
