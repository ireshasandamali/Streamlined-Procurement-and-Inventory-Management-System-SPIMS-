                                    ...
                                    <tbody  style="text-align: center; vertical-align: middle;">
                                        ...
                                        foreach ($listP as $key => $resultP) {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" id="Unit_priceEV<?= $resultP['TItemid'] ?>" name="Unit_priceEV[<?= $resultP['TItemid'] ?>]" onchange="PriceLItem(<?= $resultP['TItemid'] ?>)" value="<?= set_value('Unit_priceEV',$resultP['Unit_priceEV']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="PriceLItem<?= $resultP['TItemid'] ?>" name="PriceLItem[<?= $resultP['TItemid'] ?>]" value="<?= set_value('PriceLItem',$resultP['PriceLItem']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="OPrice<?= $resultP['TItemid'] ?>" name="OPrice[<?= $resultP['TItemid'] ?>]"onchange="TotalPEVat(<?= $resultP['TItemid'] ?>)" value="<?= set_value('OPrice',$resultP['OPrice']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="TotalPEVat<?= $resultP['TItemid'] ?>" name="TotalPEVat[<?= $resultP['TItemid'] ?>]" value="<?= set_value('TotalPEVat',$resultP['TotalPEVat']) ?>"readonly></td> 
                                                <td><input type="text" class="form-control" id="Discount<?= $resultP['TItemid'] ?>" name="Discount[<?= $resultP['TItemid'] ?>]"onchange="TotalwithDiscount(<?= $resultP['TItemid'] ?>)" value="<?= set_value('Discount',$resultP['Discount']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="TotalwithDiscount<?= $resultP['TItemid'] ?>" name="TotalwithDiscount[<?= $resultP['TItemid'] ?>]" value="<?= set_value('TotalwithDiscount',$resultP['TotalwithDiscount']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="VAT<?= $resultP['TItemid'] ?>" name="VAT[<?= $resultP['TItemid'] ?>]"onchange="VatAmount(<?= $resultP['TItemid'] ?>);TotalPIVat(<?= $resultP['TItemid'] ?>)" value="<?= set_value('VatAmount',$resultP['VatAmount']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="VatAmount<?= $resultP['TItemid'] ?>" name="VatAmount[<?= $resultP['TItemid'] ?>]" value="<?= set_value('VatAmount',$resultP['VatAmount']) ?>"readonly></td>
                                                <td><input type="text" class="form-control" id="TotalPIVat<?= $resultP['TItemid'] ?>" name="TotalPIVat[<?= $resultP['TItemid'] ?>]" value="<?= set_value('TotalPIVat',$resultP['TotalPIVat']) ?>" readonly></td>
                                            </tr>
                                            <?php
                                            $i++;
                                        }
                                    ...
                                    <tbody  style="text-align: center; vertical-align: middle;">
                                        ...
                                        foreach ($listG as $key => $resultG) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
    <input type="text" class="form-control" id="deliverydate" name="deliverydate[<?= $resultG['Item'] ?>]" value="<?= set_value('deliverydate', $resultG['deliverydate']) ?>" readonly>
</td>
