                    ...
                    <tbody>
                        ...
                        foreach ($listP as $key => $resultP) {
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-primary btn-sm" href="<?= site_url('web/viewBid/'.$resultP['IFBId'].'/'.$resultP['TId'].'/'.session()->get('UserId'))  ?>"style="color: white;padding: 0.25rem 0.5rem; ">View Bid</a>
                                </td>
                                 <?php 
...
<a class="btn btn-primary btn-sm <?= $disabled ?>" href="<?= site_url('web/viewtender/'.$resultP['IFBId'].'/'.$resultP['TId'].'/'.session()->get('UserId')) ?>" style="color: white; padding: 0.25rem 0.5rem; font-size: 0.75rem;">Apply for Bid</a>
                                <!-- Status update -->
                                 ...
                                 <!-- Status update -->
                                    ...
                                    <td> 
                                <a class="btn btn-primary"  href="<?= site_url('web/edittender/'.$resultP['IFBId'].'/'.$resultP['TId'].'/'.session()->get('UserId')) ?>"style="color: white;">Edit</a>
                                <!-- Status update -->
