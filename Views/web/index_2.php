            ...
            <div class="container" >
                <div class="row">
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <div><a href="#about" class="btn-get-started scrollto">STREAMLINE PROCUREMENT & INVENTORY MANAGEMENT SYSTEM</a></div>
                        <h1 style="color:  #00001a;">Procurement processes kept simple, made smarter</h1>
                        <h5 style="color:  #000000;">Gain transparency of the purchasing through the full automation of the procurement process. Streamlined approvals, smart budgeting and expense tracking, automated PR and PO processing all in one app.</h5>
        ...
        <main id="main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4" data-wow="fade-right" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color: #cc8800; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/invitation.jpg') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4" data-wow="fade-right" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color: #99ff66; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/procurementplan.jpg') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                                ...
                                <p class="description hidden">Procurement Planning is the first step in the Public Procurement process provides direction and time targets for procurement activities.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4"  data-wow="fade-left" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color: #ffff99; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/vote.png') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4" data-wow="fade-left" data-wow-delay="0.1s">
                            <div class="icon-box" style="background-color:  #00e6e6; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/request.jpg') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                                ...
                                <p class="description hidden">Managing purchase requests is essential for maintaining a well-Organized procurement process and ensuring timely delivery of goods.</p>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #ffff4d; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/procurementmanagement.jpg') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                                <div class="icon"><i class="bi bi-clock" style="color: #4680ff;"></i></div>
                                <h4 class="title"><a href="<?= site_url('web/GeneralInfo/') ?>">GENERAL PROCUREMENT INFORMATION</a></h4>
                                <p class="description hidden">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #00b33c; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/inventory4.jpg') ?>" class="img-fluid mx-auto d-block service-image"  alt="">
                                <div class="icon"><i class="bi bi-globe" style="color: #d6ff22;"></i></div>
                                <h4 class="title"><a href="">Inventory Management</a></h4>
                                <p class="description hidden">Manage the flow of raw materials from their procurement to finished products. It responsible for ordering and tracking stock as it arrives. </p>                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
                            <div class="icon-box" style="background-color: #b36b00; padding: 10px; max-width: 250px;">
                                <img src="<?= ('public/assets_web/img/card/spesification.jpg') ?>" class="img-fluid mx-auto d-block" class="img-fluid mx-auto d-block service-image"  alt="">
                                <div class="icon"><i class="bi bi-clock" style="color: #4680ff;"></i></div>
                                <h4 class="title"><a href="">SPECIFICATION</a></h4>
                                <p class="description hidden">Technical Specifications will be prepared by a panel of experts and shared on the system to use as a guide for drafting technical specifications.</p> 
                            </div>
                        </div>
                    </div>                     
                </div>
            ...
            <section id="portfolio" class="portfolio" style="background: linear-gradient(to bottom, #ccff99 0%, #333300 100%);">
                <div class="container">
                    ...
                    <div class="section-title">
                        <h2>Registration</h2>
                        <p>Register to gain transparency of the purchasing through the full automation of the procurement process. Streamlined approvals, smart budgeting and expense tracking, automated Procurement processing all in one app.</p>
                    </div>
                             ...
                             <div class="card"  onmouseover="displayMessage(this)" onmouseout="hideMessage(this)">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Procuring Entities</h5>
                                     <div class="message" style="display: none;position: absolute; top: 50%;left: 50%;transform: translate(-50%, -50%);background-color: rgba(255, 255, 255, 0.9);
                                      padding: 10px;border-radius: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);background-color: #79ff4d;">By registering with us, you'll gain access to a comprehensive suite of tools and resources designed to streamline every aspect of the procurement life cycle.
                                     </div>
                                    <a href="<?= site_url('web/registeredSupplier') ?>"><button type="button" class="btn btn-primary btn-sm" style="color: white;">Register</button></a>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-3 col-md-4 col-4">
                            ...
                            <div class="gallery-item">
                                <a href="<?= base_url('public/assets_web/img/gallery/gallery-8_1.jpg') ?>" class="galleery-lightbox" data-gallery="gallery-item">
                                    <img src="<?= base_url('public/assets_web/img/gallery/gallery-8_1.jpg') ?>" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="<?= base_url('public/assets_web/img/gallery/gallery-13-1.jpg') ?>" class="galleery-lightbox" data-gallery="gallery-item">
                                    <img src="<?= base_url('public/assets_web/img/gallery/gallery-13-1.jpg') ?>" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="<?= base_url('public/assets_web/img/gallery/gallery-25.jpg') ?>" class="galleery-lightbox" data-gallery="gallery-item">
                                    <img src="<?= base_url('public/assets_web/img/gallery/gallery-25.jpg') ?>" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="<?= base_url('public/assets_web/img/gallery/gallery-05.jpg') ?>" class="galleery-lightbox" data-gallery="gallery-item">
                                    <img src="<?= base_url('public/assets_web/img/gallery/gallery-05.jpg') ?>" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
