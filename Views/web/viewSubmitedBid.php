        ...
        <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;"> 
            ...
            <div class="card-body">
                ...
                foreach ($listP as $key => $resultP) {
                    ...
                    ?>                     
                    <?= form_open_multipart('web/viewSubmitedBid') ?>
                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <strong><input type="text" name="AnnounceId" value="<?= $result['id'] ?>">BID Validation Period</strong> </td>
                                ...
                                foreach ($listP as $key => $resultP) {
                                    ?>
                                    <tr>
                                        <td> <strong><input type="text" name="TenderId" value="<?= $resultP['TId'] ?>">Procurement Number</strong> </td>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($lists as $key => $results) {
                                    ...
                                    <tr>
                                        <th scope="row"><?= $i ?> </th>
                                        <td><input type="hidden" name="Qty[<?= $results['IId'] ?>]" value="<?= $results['Item'] ?>"><?= $resulti['Item'] ?></td>
                                        <td><?= $results['SubComponent'] ?></td>
                                        <td><?= $results['Detail'] ?></td>
                                        <td><?= $results['Priority'] ?> </td>
                                        <td><select class="form-control" id="Cost" name="Offer[<?= $results['IId'] ?>]">
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select></td>
                                        <td><textarea  class="form-control col-sm-10" id="Remarks" name="Remarks[<?= $results['IId'] ?>]" placeholder="Toners for Photocopy machine"></textarea></td>                   
                                    </tr>
    <?php
    $i++;
}
