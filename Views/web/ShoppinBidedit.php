                            ...
                            <tr>
                                ...
                                <td><?= $resultP['Description'] ?> </td>
                                 ...
                                 $disabled = null;
                                    ...
                                    <td> 
<a class="btn btn-primary btn-sm<?= $disabled ?>" href="<?= site_url('web/viewtenders/'.$resultP['sannounceId'].'/'.$resultP['TId'].'/'.session()->get('UserId')) ?>" style="color: white; padding: 0.25rem 0.5rem; font-size: 0.75rem;">Apply for Bid</a>
                                <!-- Status update -->
                                 ...
                                 <!-- Status update -->
                                    ...
                                    <td> 
                                <a class="btn btn-primary"  href="<?= site_url('web/edittenders/'.$resultP['sannounceId'].'/'.$resultP['TId'].'/'.session()->get('UserId')) ?>"style="color: white;">Edit</a>
                                <!-- Status update -->
                ...
                <p>02.	Bidding will be conducted through National Shopping Procedure.</p>
                <p>03.  Interested eligible bidders may obtain further information from Director/Logistics, STF & inspect the bidding documents from the address given below from 0900 hrs, to 1500 hrs, on any working days except on Public & Bank Holidays from   <strong><?= $result['BStarts'] ?></strong>  until <strong> <?= $result['BEnds'] ?></strong>.</p>
                <p>05.	Bids must be applied before date of opening (<strong><?= $result['BOpens'] ?></strong>) of the respective tenders.</p>
                ...
                <h6>iii.In favor of Commandant / STF.</h6>
                 <?php
                $initialDate = $result['BOpens'];
                $newDate = date('d.m.Y', strtotime($initialDate . ' +90 days'));
                ?>
