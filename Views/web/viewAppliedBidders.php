        ...
        <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;"> 
            ...
            <div class="card-body">
                <h5 class="card-title" style="background-color: #f0f0f0; padding: 10px;">
                    We confirmed that this bid was opened by the procurement guidelines and rules, and it was opened on time at Commandant / Special Task Force, STF Headquarters, No: 223, Bauddhaloka Mawatha, Colombo 07                </h5>
                    ...
                    <table class="table table-striped  ">
                        <tbody>
                            ...
                            foreach ($listP as $key => $resultP) {
                                ?>                              
                                <tr>
                                    <td> <strong>Procurement Number</strong> </td>
                ...
                <table class="table">
                    <thead style="vertical-align: middle;">
                        ...
                        <tr>
                            ...
                            <th scope="col">Total Bidding Value</th>
                        ...
                        foreach ($listB as $key => $resultB) {
                            ...
                            <tr>
                                ...
                                <td><?= $resultB['business_name'] ?> </td>
                                 <td><?= number_format($resultB['TotalP'],2) ?> </td>
