        ...
        <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;"> 
            ...
            <div class="card-body">
                ...
                foreach ($listP as $key => $resultP) {
                    ...
                    ?>                     
                    <?= form_open_multipart('web/viewtenderaddmoreimage') ?>
            ...
            <?= form_open_multipart('web/uploadimage') ?>
            <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;">             
                    ...
                    <div class="container uploaded-container">
                        ...
                        <div class="row uploaded-row">
                            <div class="col-12 doc">
                                <div class="mb-3">
                                    <h5>Upload NCB Bidding Documents</h5><hr>
                                            <p><strong>Once You finalized the bid Submission Form, please upload the finalized Bid document as a PDF file.</strong></p>                                    
                                    <p>(Bid Submission Form/License /Registration / 
                                            performance Documents If Any)</p>
                                    
                                    <!----><!----> 
                                    <div class="row mb-3">
                                        <label for="profile_image[]" class="col-sm-2 control-label">Documents Attached </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                        <label for="file_name[]" class="col-sm-2 control-label">Title of the document</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="file_name[]" id="file_name[]" placeholder="ex: Registration Document" required="required">
                                        </div>
                                    </div>
                                    
                                    <div class="col-sm-4">
                                        <button type="submit" class="btn btn-success" name="submit"> <i class="bi bi-plus-square" aria-hidden="true"></i> Add New Document </button>
                                    </div>
                                         <!-- check -->
            ...
            <!-- Check This code get from chatgpt -->
