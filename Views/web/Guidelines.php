...
<html lang="en">
    ...
    <section id="services" class="services section-bg"> 
        ...
        <section class="section dashboard" style="margin-top: 80px; margin-left: 80px; margin-right: 80px; padding-top: 50px;">
            <div class="card" style="border-top: 2px solid blue; border-bottom: 2px solid blue;">
                <div class="card-body">
                    <h1>Procurement Guidelines & Manuals</h1>
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    <table class="table table-striped table-hover" style="font-size: larger">
                                        <tbody><tr>
                                                <td>  Procurement Guidelines 2006 Goods and Works <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/ProcurementGuidelines2006.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>

                                            </tr>
                                            <tr>
                                                <td>  Procurement Manual 2006 <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/ProcurementManual2006.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
                                            <tr>
                                                <td> Guide to project management &amp; contract management for infrastructure development projects (Works)  <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/Guide to Project and Contract Management2017.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
                                            <tr>
                                                <td>  Selection &amp; Employment Of Consultants <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/CONSULTANT_GUIDELINE_AUGUST_2007.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
                                            <tr>
                                                <td> Consulting services manual- November 2007   <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/ConsultingServicesManualNovember2007.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
                                            <tr>
                                                <td>  Guidelines on Private Sector Infrastructure Projects (Government Tender Procedure - Part II) <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/PrivateSectorInfrastructureProjects.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
                                            <tr>
                                                <td> Guidelines for Procurement of Pharmaceuticals &amp; Medical Devices - 2022 <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                               <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/Guidelines for Procurement of Pharmaceuticals & Medical Devices of a Consumable Nature - 2022-20230206.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                                </tr>
                                            <tr>
                                                <td> Bidder's guide to success in public procurement archive of NPA publications <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                    <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/Bidders_Guide.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                            </tr>
