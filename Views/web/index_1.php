            ...
            <div class="container" >
                <div class="row">
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        ...
                        <h2 style="color:  #000000;">Gain transparency of the purchasing through the full automation of the procurement process. Streamlined approvals, smart budgeting and expense tracking, automated PR and PO processing all in one app.</h2>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const imagePaths = [
                '<?= base_url('public/assets_web/img/gallery-12.jpg') ?>',
                 ...
                 '<?= base_url('public/assets_web/img/gallery-04.jpg') ?>',
