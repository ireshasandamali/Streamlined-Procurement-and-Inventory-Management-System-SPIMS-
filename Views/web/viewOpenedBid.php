                    ...
                    <tbody>
                        ...
                        foreach ($listP as $key => $resultP) {
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a class="btn btn-primary btn-sm<?= $disabled ?>" href="<?= site_url('web/viewAppliedBidders/' . $resultP['IFBId'] . '/' . $resultP['TId'] . '/' . session()->get('UserId')) ?>" style="color: white; padding: 0.25rem 0.5rem; font-size: 0.75rem;">View Bidders</a>
                                    <!-- Status update -->
