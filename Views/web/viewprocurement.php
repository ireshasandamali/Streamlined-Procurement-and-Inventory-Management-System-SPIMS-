...
<html lang="en">
    ...
    <body>
        ...
        <section class="section dashboard" style="margin-top: 80px; margin-left: 80px; margin-right: 80px; padding-top: 50px;">
          <div class="card">
              <div class="card-header" style="background-color:#5c5cd6; color: white">
                  Primary Details
              </div>
      ...
      <div class="box-body no-padding">
        ...
        <table class="table table-striped  ">
          <tbody>
            ...
            <tr>
              <td style="width:30%;"> <strong>Procurement Item Number</strong> </td>
              <td><?= $i?> </td>
            </tr>
            <tr>
            ...
            <tr>
              <td> <strong>Procurement Vote</strong> </td>
              <td> <?= $result['Vote'] ?> </td>
            </tr>
            <tr>
              <td> <strong> Vote Description</strong> </td>
              <td><?= $result['Description'] ?></td>
            </tr>
            <tr>
              <td> <strong> Vote Allocation</strong> </td>
