            ...
            <section id="services" class="services section-bg">
                <div class="container">
                    ...
                    <div class="section-title">
                        ...
                        <?php foreach ($list as $key => $result) { ?><h5><?= $result['Year'] ?> YEAR</h5>
                            <?php
                            break;
                        }
                        ?>      
                        ...
                        <p style="font-family: 'TSG Bolt', 'Ittali'; color: #000000;font-size: 20px;">Procurement Guideline Reference : 4.2.1</p>
                        <p style="font-family: 'Bolt'">Procurement Planning is the first step in the Public Procurement process provides direction and time targets for procurement activities. This will also help procuring entities their procurement actions and ensure required budgetary provisions for each activity in advance. Procurement Entities are requested to prepare their Procurement Plan and upload that into the SPIMS soon as their budgetary allocations are confirmed. This will also help vendors and contractors to plan their bidding for public procurement well in advance and respond to those Notices on time.</p>
                    </div>

                    <div class="row">
                        <section class="section dashboard">        
                            <div class="card"> 
                                <div class="card-header" style="background-color: #7070db; color: white;">PROCUREMENT PLAN - <?= $result['Year'] ?> </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list as $key => $result) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url('web/viewprocurement/') . $result['id'] ?>">View Items</a></button></td>                                           
                                                </tr>
                                                <?php
                                                $i++;
                                            }
