                            ...
                            <tr>
                                ...
                                <td><?= $resultP['Tname'] ?> </td>
                                 ...
                                 $disabled = null;
                                    ...
                                    <td> 
<a class="btn btn-primary btn-sm<?= $disabled ?>" href="<?= site_url('web/viewtenders/'.$resultP['announceid'].'/'.$resultP['TId'].'/'.session()->get('UserId')) ?>" style="color: white; padding: 0.25rem 0.5rem; font-size: 0.75rem;">Apply for Bid</a>
                                <!-- Status update -->
