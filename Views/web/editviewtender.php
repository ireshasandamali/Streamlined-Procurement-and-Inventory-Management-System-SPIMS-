        ...
        <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;"> 
            ...
            <div class="card-body">
                ...
                foreach ($listP as $key => $resultP) {
                    ...
                    ?>                     
                    <?= form_open_multipart('web/editviewtender') ?>
                            ...
                            <div class="col-12 doc">
                                <div class="mb-3">
                                    <h5>Upload NCB Bidding Documents</h5><hr>
                                            <p  class="text-muted"><strong>Once You finalized the bid Submission Form, please upload the finalized Bid document as a PDF file.</strong></p>                                    
                                    ...
                                    <!----><!----> 
                                    <div class="row mb-3">
                                        <label for="profile_image[]" class="col-sm-2 control-label">Bid Submission Form </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                         <label for="profile_image[]" class="col-sm-2 control-label">Business registration </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                         </div>
                                        <div class="row mb-3">
                                         <label for="profile_image[]" class="col-sm-2 control-label">Registration under Public contract Act (PCA3) </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                         <label for="profile_image[]" class="col-sm-2 control-label">Manufacture Authorization </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                    </div>
                                     <div class="row mb-3">
                                        <label for="profile_image[]" class="col-sm-2 control-label">Manufacture’s original technical brochures </label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                         <label for="profile_image[]" class="col-sm-2 control-label">Other Documents</label>
                                        <div class="col-sm-4">
                                            <input type="file" class="form-control"  id="profile_image[]" name="profile_image[]" required="required" extension="pdf" filesize="9000000">
                                        </div>
                                         </div>
