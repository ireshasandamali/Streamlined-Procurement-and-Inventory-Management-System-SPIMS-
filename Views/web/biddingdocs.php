        ...
        <section id="services" class="services section-bg"> 
            ...
            <section class="section dashboard" style="margin-top: 80px; margin-left: 80px; margin-right: 80px; padding-top: 50px;">
                <div class="card" style="border-top: 2px solid blue; border-bottom: 2px solid blue;">
                    <div class="card-body">
                        <h1>Standard Bidding Documents </h1>
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-striped table-hover" style="font-size: larger">
                                            <tbody><tr>
                                                    <td>  Procurement of Goods under National Shopping Procedure<i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                        <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/NSProceduresGoods.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>

                                                </tr>
                                                <tr>
                                                    <td> Procurement of Goods under National Competitive Bidding Procedure<i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                        <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/ProcurementGoodsNCB.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                                </tr>
                                                <tr>
                                                    <td> Procurement of Goods under National Competitive Bidding Procedure (Forms)  <i class="fa fa-arrow-right" aria-hidden="true"></i> 
                                                        <a class="btn btn-outline-dark btn-sm" href="<?= site_url('public/images/donloadsDocument/ProcurementOfGeneralGoodsNCBForms.pdf') ?>" target="_blank"><i class="bi bi-download"></i> Download </a>
                                                </tr>
