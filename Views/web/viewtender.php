            ...
            <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;"> 
                ...
                <div class="card-body">
                    ...
                    foreach ($listP as $key => $resultP) {
                        ...
                        ?>                     
                        <?= form_open_multipart('web/viewtender',['novalidate'=> 'novalidate']) ?>
                                        ...
                                        foreach ($listi as $key => $resulti) {
                                            ...
                                            <tr>
                                              ...
                                              <td><input type="hidden" name="Unit[<?= $resulti['TItemid'] ?>]" value="<?= $resulti['Unit'] ?>" id="Unit<?= $resulti['TItemid'] ?>"><?= $resulti['Unit'] ?></td>
                                                ...
                                                <td><input type="text" class="form-control" id="VAT<?= $resulti['TItemid'] ?>" name="VAT[<?= $resulti['TItemid'] ?>]" value="18" onchange="VatAmount(<?= $resulti['TItemid'] ?>);TotalPIVat(<?= $resulti['TItemid'] ?>)"></td>
