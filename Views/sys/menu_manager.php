    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?= site_url('check/Circulars')?>">
              <i class="bi bi-circle"></i><span>View Supplier</span>
            </a>
          </li>
          <li>
            <a href="<?= site_url('supplier/edit')?>">
              <i class="bi bi-circle"></i><span>Edit Supplier</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav0" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= site_url('tender/create')?>">
              <i class="bi bi-circle"></i><span>Create Tender</span>
            </a>
          </li>
          <li>
           <a href="<?= site_url('tender/update')?>">
              <i class="bi bi-circle"></i><span>Update Tender</span>
            </a>
          </li>
          <li>
