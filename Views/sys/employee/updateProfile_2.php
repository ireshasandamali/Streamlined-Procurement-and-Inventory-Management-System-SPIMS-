                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php foreach ($list as $key => $result): ?>
                            <div class="form-group">
                                    <label for="employee_email" class="form-label">User Name</label>
                                    <input style="border-radius: 40px;border: 1px solid  #000066"type="email" class="form-control" id="employee_email">
                                </div>
                                <div class="form-group">
                                    <label for="employee_name" class="form-label">Current Password</label>
                                    <input style="border-radius: 40px;border: 1px solid  #000066"  type="text" class="form-control" id="employee_name">
                                </div>
                             <div class="form-group">
                                    <label for="employee_name" class="form-label">New Password</label>
                                    <input style="border-radius: 40px;border: 1px solid  #000066"  type="text" class="form-control" id="employee_name">
                                </div>
                                
                                <div class="form-group">
                                    <label for="employee_tel" class="form-label">Confirm Password</label>
                                    <input style="border-radius: 40px;border: 1px solid  #000066" type="text" class="form-control" id="employee_tel">
                                </div><br>
                            <div class="form-group text-center">
                            <button style="border-radius: 40px;border: 1px solid  #000066"  type="submit" class="btn btn-primary">Save</button>  
                            <button style="border-radius: 40px;border: 1px solid  #000066"  type="submit" class="btn btn-primary">Reset</button>  
                             </div>
                            <!-- Alert Messages -->
                                <?php if (isset($msg)): ?>
