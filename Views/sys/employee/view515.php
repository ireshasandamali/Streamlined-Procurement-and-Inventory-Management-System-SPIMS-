            ...
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <!--<table class="table table-sm  table-coler-#b3d9ff table-bordered" > -->
                            ...
                            <table id="employeeTable" class="table table-striped thead-light">
...
<div class="pagination" style="display: inline-block;background-color: #ddd; padding: 8px 16px; border: 1px solid #ddd; margin: 0 4px;">
  <a href="#">&laquo;</a>
  <a href="#">1</a>
