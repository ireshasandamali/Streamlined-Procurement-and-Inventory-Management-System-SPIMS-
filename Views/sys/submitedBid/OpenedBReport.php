        ...
        <section class="section dashboard">        
            ...
            <div class="card" style="margin-top: 5px; margin-left: 25px;margin-right: 25px;">
                ...
                <div class="card-body">
                    ...
                    <?= form_open_multipart("SubmitedBid/OpenedBReport/$AnnounceId/$TenderId/$VendorId") ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">  
                        <div class="col-sm-12">
                            ...
                            <?php
                                $i = 1;
                                  foreach ($listOR as $key => $resultOR) { ?>
                                            
                                            <textarea  class="form-control col-sm-10" id="remarks" name="remarks"><?= $resultOR['remarks'] ?></textarea>
                                          <?php
                                            }
                                            ?>
