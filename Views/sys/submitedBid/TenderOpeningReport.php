...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <div class="tab-content">
            ...
            <div class="card-header" style="background-color: #7070db; color: white;">Bid Opening Report</div>
            <div class="card-body">
                ...
                <div class="row g-3">  
                    ...
                    <div class="col-md-2">
                        <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('SubmitedBid/TenderOpeningReport') ?>">
                            Reset
