    ...
    <div class="pagetitle">
        ...
        <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open('SubmitedBid/OpenedSBid') ?>
                <div class="row g-3">  
                    <div class="col-md-1">
                                        ...
                                        foreach ($listP as $key => $resultP) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary <?= $disabled ?>" type="button" href="<?= site_url('SubmitedBid/ViewSBidders/'.$resultP['IFBId'].'/'.$resultP['TId']) ?>"style="color: white;">Open</a></td>            
                                            </tr>
                                            <?php
                                            $i++;
                                            }
