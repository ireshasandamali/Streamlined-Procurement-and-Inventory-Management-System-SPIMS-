    ...
    <div class="pagetitle">
        ...
        <section class="section dashboard">
            ...
            <div class="card" style="margin-top: 10px;"> 
                <div class="card-header" style="background-color: #7070db; color: white;">Request Progress</div>
                <div class="card-body">
                    <h6 class="card-title"></h6> 
  
                    <?= form_open('itemrequest/viewReqprogress') ?>
                    <div class="row g-3">  
                        <div class="col-md-1">
                        ...
                        <div class="col-md-2">
                            <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('itemrequest/viewReqprogress') ?>">
                                Reset
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" >
                        <table class="table table-sm table-striped table-coler-#b3d9ff table-bordered" id="RequestTable">
                            <thead style="text-align: center; vertical-align: middle; border-bottom: 2px solid #001a66; border-top:  2px solid #001a66">
                                <tr>
                                    ...
                                    <th scope="col">Request Date</th>
                                     <th scope="col">Request Approved Date</th>
                                     <th scope="col">Tender ID</th>
                                    <th scope="col">Tender Process Starting Date</th>
                                    <th scope="col">Tender Process End Date</th>
