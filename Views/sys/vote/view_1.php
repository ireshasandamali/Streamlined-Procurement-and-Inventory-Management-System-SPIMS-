                    ...
                    <tbody>
                        ...
                        foreach ($list as $key => $result) {
                            ...
                            <tr>
                                ...
                                <td><?= number_format($result['Allocation'],2) ?></td>
                                <td><a class="btn btn-primary" href="<?= site_url('vote/editVote/' . $result['id']) ?>"> Edit</a>
                                 <td>        
                                     <!-- delete confirmation message -->

                        <input type="hidden" name="id" value="<?= $result['id'] ?>"><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                                                                             onclick="confirmDeleteModal('<?= $result['id'] ?>')">Delete </button>
                        <a href="javascript:void(0)" onclick="confirmDelete(<?= $result['id'] ?>)">Delete</a>
                         <!-- Modal -->
