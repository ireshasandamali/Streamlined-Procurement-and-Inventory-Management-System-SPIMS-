            ...
            <div class="col-4">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">                       
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="index.html">Allocations</a></li>
                ...
                <div class="card-body">
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        ...
                        <div class="col-md-2">
                            <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('vote/view') ?>">
                                Reset
                        ...
                        foreach ($list as $key => $result) {
                            ...
                            <tr>
                                ...
                                <td><?= $result['Description'] ?></td>
                                 <td style="text-align: center"><?= number_format($result['Allocation'],2) ?></td>
                                  <?php if((session()->get('UserType'))=='Procurement Planning Officer'){ ?>
                                <td>        
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger" id="confirmDelete<?= $result['id'] ?>" href="<?= site_url('vote/removeItem/' . $result['id']) ?>">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function confirmDeleteModal(voteid) {
        ...
        var modalId = "#deleteModal" + voteid;
        var msgId = "#msg" + voteid;
        var confirmDeleteId = "#confirmDelete" + voteid;

        // Set the item ID in the modal body
        $(msgId).html("Are you sure you want to delete item ID: " + voteid + "?");
