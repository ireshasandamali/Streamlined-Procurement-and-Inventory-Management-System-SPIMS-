<main id="main" class="main">
   ...
   <div class="card" style="margin-top: 5px;"> 
          ...
          <h1 class="card-title lead" style="text-align:center">Procurement Documents</h1><hr>                              
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" href="<?= site_url('tender/editcreatecostestimate/' . $result['Tenderid']) ?>">Edit Cost Estimate</a>
                            </td>
                        </tr>
                    </thead>
                </table>
                        ...
                        <div class="card col-md-4" style="border: 2px solid #CCCCFF;width: 50%;">
                            <div class="card-body">
                                <h2 class="card-title lead" style="text-align:center">Items</h2>
            ...
            <!-- End Table Variants -->
            <div class="card" style="margin-top: 10px;"> 
                <div class="card-header" style="background-color: #7070db; color: white;">Document Evaluation</div>
                <div class="card-body">
    ...
    <?php if ($result['specStatus'] == '2') {
        ?>
                                    ...
                                    <tr>
                                        <td><a href="<?= site_url('tender/ViewTCEstimate/' . $result['Tenderid']) ?>"><button type="button" class="btn btn-success btn-sm" style="color: black;">Cost Estimate</button></a></td>
                                        <td>
