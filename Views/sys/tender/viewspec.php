<main id="main" class="main">
    <div class="pagetitle">
        ...
        <section class="section dashboard">
            <h5 class="card-title" style="text-align: center; background-color: #7070db; color: white; margin-bottom: 0;">Specification List</h5>
            ...
            <div class="card" style="margin-top: 10px;"> 
                <div class="card-body">
                    ...
                    <!-- Multi Columns Form -->
                  <?= form_open('tender/viewspec/') ?>

                   <!-- <div class="row g-3">


                        <div class="col-md-6">
                            <label for="ItemName" class="form-label">Search By Item Name</label>
                        ...
                        <div class="col-md-2">
                            <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('tender/viewspec') ?>">
                                Reset
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Technical Specifications & Compliance</h5>
                    <!-- Table Variants -->
                    <table class="table">
                        <thead>
                            <tr>
