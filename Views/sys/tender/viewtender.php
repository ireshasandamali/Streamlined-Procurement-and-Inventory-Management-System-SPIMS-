                                ...
                                <thead>
                                 ...
                                 $spec = $result['specStatus'];
                                     ...
                                     ?>
                                            ...
                                            <a  class="btn btn-success btn-sm <?= $disabled ?>" href="<?= site_url('tender/createSpec/' . $result['Tenderid']) ?>">Create Specification</a>    
                                        </td>
                                        <td>
                                 ...
                                 $spec = $result['specStatus'];
                                     ...
                                     ?>
                                            ...
                                            <a  class="btn btn-info btn-sm  <?= $disabled ?>" href="<?= site_url('tender/createSpec/' . $result['Tenderid']) ?>">Edit Specification</a>    
                                        </td>
                                        <td>
                                                      <?php 
                                 
                                 $estimate = $result['costStatus'];
                                     $disabled = null;
                                     ...
                                     ?>
                                            <a class="btn btn-success btn-sm  <?= $disabled ?>" href="<?= site_url('tender/createcostestimate/' . $result['Tenderid']) ?>">Create Cost Estimate</a>
                                        </td>
                                 ...
                                 $estimate = $result['costStatus'];
                                     ...
                                     ?>
                                            <a class="btn btn-info btn-sm  <?= $disabled ?>" href="<?= site_url('tender/editcreatecostestimate/' . $result['Tenderid']) ?>">Edit Cost Estimate</a>
                                        </td>
                                    </tr>
                                </thead>
                            </table>
