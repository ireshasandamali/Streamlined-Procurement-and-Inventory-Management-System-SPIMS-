                    ...
                    <div class="col-md-12">
                        <div class="card" style="border: 2px solid  #ccd9ff; border-radius: 0;">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                        <label for="ADate" class="col-sm-6 col-form-label">Performance Bond</label>
                                          <label for="PBond" class="col-sm-6 col-form-label">Performance Bond in Letter</label>
                                        
                                    </div>
                                    <div class="row mb-3">                               
                                        <div class="col-sm-6"> 
                                            <input type="text" class="form-control" id="PBond" name="PBond"  >
                                            <span class="text-danger"><?= service('validation')->getError('PBond') ?></span>
                                        </div>

                                        <div class="col-sm-6">
                                             <input type="text" class="form-control" id="v" name="PBondl">
                                ...
                                <div class="row mb-3">
                                        <label for="LDate" class="col-sm-6 col-form-label">Date of Letter</label>
                                          <label for="LetterNo" class="col-sm-6 col-form-label">Letter No</label>
                                        
                                    </div>
                                    <div class="row mb-3">                               
                                        <div class="col-sm-6"> 
                                            <input type="date" class="form-control" id="LDate" name="LDate"  >
                                            <span class="text-danger"><?= service('validation')->getError('LDate') ?></span>
                                        </div>
...
<script>
    function constructURLAndRedirect() {
        ...
        var url = "<?= site_url('Awarding/createLetterofIntent/') ?>" + tenderId + '/' + vendorId + '/' + ADate + '/' + PBond + '/' + PBondl + '/' + VDate + '/' + LDate + '/' + LetterNo;
        //alert(url);
