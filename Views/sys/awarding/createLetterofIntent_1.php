...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <!-- Tender->View -->
                           ...
                           <br>  
                          <div class="row mb-3">
                                    <label for="Item" class="col-sm-8 col-form-label" style="font-weight: bold;">Letter No :</label>
                                    <label for="Qty" class="col-sm-4 col-form-label" style="font-weight: bold;">Date:</label>
                                </div>
                                <div class="row mb-3">                               
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control" id="Costtotal" name="TAwarding" value="<?= set_value('STF/LOG/TENDER/') ?>">
