                    ...
                    <div class="col-md-12">
                        <div class="card" style="border: 2px solid  #ccd9ff; border-radius: 0;">
                            <div class="card-body">
                                ...
                                <?= form_open('Awarding/LetterofIntent') ?>
                                ...
                                <div class="row mb-3">                               
                                    ...
                                    <div class="col-sm-6" id="ItemNameList">
                                        ...
                                        <input type="text" class="form-control" id="Costtotal" name="Costtotal"  >
                                    </div>
                                </div>

                                    <div class="row mb-3">
                                        <label for="ADate" class="col-sm-6 col-form-label">Date of the Letter</label>
                                          <label for="PBond" class="col-sm-6 col-form-label">Letter No</label>
    ...
    function constructURLAndRedirect() {
      ...
      //  var PBond = document.getElementById('PBond').value;
       ...
       // var PBondl = document.getElementById('PBondl').value;
        ...
        var url = "<?= site_url('Awarding/createLetterofaward/') ?>" + tenderId + '/' + vendorId + '/' + ADate + '/'  + LetterNo;
        //alert(url);
