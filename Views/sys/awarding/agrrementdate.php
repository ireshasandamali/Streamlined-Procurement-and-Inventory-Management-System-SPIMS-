        ...
        <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?= form_open('Awarding/agrrementdate') ?>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <label for="PBond" class="col-sm-6 col-form-label">Performance Bond Validity Period</label>
                    </div>
                    <div class="row mb-3">                               
                        <div class="col-sm-6">
                    ...
                    <div class="text-center">
                        <!-- use submit button -->
                        <a type="submit" class="btn btn-primary btn-sm" href="<?= site_url('Awarding/createLetterofIntent/') ?>">Awarding Letter</a>                                
                    </div>
                </div>
       <?= form_close() ?>
