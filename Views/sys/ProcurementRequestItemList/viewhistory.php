<main id="main" class="main">
        ...
        <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <?= form_open('ProcurementRequestItemList/viewhistory') ?>
                    <div class="row g-3">                              
                       <div class="col-md-3">
 ...
 <select style="border-radius: 40px;border: 1px solid  #000066"  id="Vote" class="form-select" name="Vote">
                    ...
                    <div class="row g-3">                              
                        ...
                        <div class="col-md-3">
                            <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('ProcurementRequestItemList/viewhistory') ?>">
                                Reset
                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                     ...
                                     <td><a class="btn btn-success btn-sm" href="<?= site_url('ProcurementRequestItemList/viewmore/' . $result['id']) ?>">View</a></td>
                                        ...
                                        <td>  
                                            ...
                                            <input type="hidden" name="Item" value="<?= $result['Item'] ?>">
