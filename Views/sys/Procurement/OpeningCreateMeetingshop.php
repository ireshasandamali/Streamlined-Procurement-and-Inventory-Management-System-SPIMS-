        ...
        <section class="section dashboard">        
            <div class="card" style="margin-top: 10px;"> 
                ...
                <div class="card-body">
                    ...
                    <!-- Multi Columns Form -->
                    <?= form_open_multipart('Procurement/OpeningCreateMeetingshop') ?>
                                ...
                                <div class="col-sm-12">
                                    <select id="BOpenId" class="form-select" name="BOpenId"  onchange="loadopendate(this.value)">
                                        ...
                                        <?php foreach ($lista as $key => $resulta) { ?>
                                            ...
                                            <option value="<?= $resulta['ids'] ?>"><?= $resulta['BOpens'] ?></option>
                    ...
                    <script>
                        function  loadopendate(Oid) {
                             alert(Oid);
                            var formData = "ids=" + Oid + "&";
                            //alert(formData);
                            $.ajax({
                                type: 'POST',
                                url: '<?= site_url('Procurement/getOpendates') ?>',
                                data: formData,
