    ...
    <section class="section dashboard">        
         <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open_multipart('Procurement/EvaluationCommittee') ?>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="MDate" class="form-label">Appointed Date</label>
                    ...
                    <input type="Purpose" class="form-control" id="Purpose" name="Purpose" value="TEC">                         
                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="checkbox" class="form-check" id="EmpId<?= $i ?>" name="EmpId[<?= $result['UserId'] ?>]" value="<?= $result['UserId'] ?>"></td>
...
<script>
    function  loadDescription(Tid) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= site_url('Procurement/getDescription') ?>',
            data: formData,
