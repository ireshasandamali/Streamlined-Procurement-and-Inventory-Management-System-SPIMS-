    ...
    <section class="section dashboard">        
         <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open_multipart('Procurement/PCReccomendation') ?>
                        ...
                        <table class="table table-sm table-striped table-coler-#b3d9ff table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($listC as $key => $resultC) {
                                    ?>
                                    <tr>
                                        <td style="font-size: 12px;"><input type="hidden" name="PMId" value="<?= $resultC['id'] ?>"><?= $resultC['id'] ?></td>
                                        <td style="font-size: 12px;"><?= $resultC['PMDate'] ?></td>
                                        <td><a class="btn btn-primary" type="button" href="<?= site_url('Procurement/procurementrecommend/'.$resultC['id']) ?>"style="color: white;">Open</a></td>                                                       
                                    </tr>
                                    <?php
                                    $i++;
                                }
