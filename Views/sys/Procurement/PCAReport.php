        ...
        <section class="section dashboard">   
            ...
            <div class="card" style="margin-top: 10px;"> 
                ...
                <div class="card-body" style="margin-left: 10px;margin-right: 15px">
                    ...
                    <?php } ?>
                    <!-- Multi Columns Form -->
                    <?= form_open_multipart('Procurement/Savepcapproval') ?>
...
<table class="table table-sm table-striped table-coler-#b3d9ff table-bordered">
 ...
 <input type="hidden" name="CompanyName[<?= $resultcompany['VendorId'].$resultfacept['Itemid'] ?>]" value="<?= $resultcompany['CompanyName'] ?> ">
                                        ...
                                        <td><?= $resultfacept['ItemName'] ?> </td>
                                        <td><input type="hidden" name="Qty[<?= $resultcompany['VendorId'].$resultfacept['Itemid'] ?>]" value="<?= $resultfacept['Qty'] ?> "><?= $resultfacept['Qty'] ?> </td>
                                        <td><input type="hidden" name="Unit_priceEV[<?= $resultcompany['VendorId'].$resultfacept['Itemid'] ?>]" value="<?= $resultfacept['Unit_priceEV'] ?> "><?= number_format($resultfacept['Unit_priceEV'], 2) ?></td>
                                        <td><input type="hidden" name="TotalPIVat[<?=$resultcompany['VendorId']. $resultfacept['Itemid'] ?>]" value="<?= $resultfacept['TotalPIVat'] ?> "><?= number_format($resultfacept['TotalPIVat'], 2) ?></td>
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php
                                ...
                                foreach ($listpca as $key => $resultpmarks) { ?>
                                           ...
                                           <textarea id="Approval" name="Approval" rows="6" style="width: 100%; border: 1px solid #ccc;"><?= $resultpmarks['Approval'] ?></textarea>
                                <?php } ?>
