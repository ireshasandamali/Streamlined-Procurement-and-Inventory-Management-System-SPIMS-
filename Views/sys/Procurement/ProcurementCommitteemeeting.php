        ...
        <section class="section dashboard">        
            <div class="card" style="margin-top: 10px;"> 
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <!-- End of Alert Messages -->
                    <?= form_open_multipart('Procurement/ProcurementCommitteemeeting') ?>

                   <div class="row g-3" style="margin-bottom: 20px;">
                      
                        <div class="col-md-12">
                            <label for="PMDate" class="form-label">Meeting Date</label>
                            <input type="datetime-local" class="form-control" id="PMDate" name="PMDate">
                            <span class="text-danger"><?= service('validation')->getError('PMDate') ?></span>
                        </div>
                    </div>
                    <div class="text-center">
                        <button name="action" value="add" type="submit" class="btn btn-outline-primary rounded">Create Procurement Committee Meeting</button>
                        <button name="action" value="reset" type="reset" class="btn btn-outline-primary rounded">Reset</button>
                    </div>
