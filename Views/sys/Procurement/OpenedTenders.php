                                        ...
                                        foreach ($listP as $key => $resultP) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-sm <?= $disabled ?>" type="button" href="<?= site_url('Procurement/ViewBiddersList/'.$resultP['IFBId'].'/'.$resultP['TId']) ?>"style="color: white;">View Bidders</a></td>            
                                            </tr>
                                            <?php
                                            $i++;
                                            }
