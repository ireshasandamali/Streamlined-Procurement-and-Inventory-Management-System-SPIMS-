    ...
    <section class="section dashboard">        
         <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open_multipart('Procurement/TECMeeting') ?>
                        ...
                        <table class="table table-sm table-striped table-coler-#b3d9ff table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($listC as $key => $resultC) {
                                    ?>
                                    <tr>
                                        <td style="font-size: 12px;"><input type="hidden" name="AnnounceId" value="<?= $resultC['PNumber'] ?>"><?= $resultC['MNumber'] ?></td>
                                        <td style="font-size: 12px;"><?= $resultC['PNumber'] ?></td>
                                        <td style="font-size: 12px;"><?= $resultC['Description'] ?></td>
                                        <td style="font-size: 12px;"><?= $resultC['MDate'] ?></td>                                       
                                        <td><a class="btn btn-primary" type="button" href="<?= site_url('BidEvaluation/TECEvaluation/'.$resultC['PNumber']) ?>"style="color: white;">Open</a></td>                                                       
                                    </tr>
                                    <?php
                                    $i++;
                                }
