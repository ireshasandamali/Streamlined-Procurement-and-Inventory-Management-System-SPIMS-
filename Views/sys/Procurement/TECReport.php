...
<table class="table table-sm table-striped table-coler-#b3d9ff table-bordered">
 ...
 <input type="hidden" name="CompanyName[<?= $resultcompany['VendorId'].$resultfacept['Itemid'] ?>]" value="<?= $resultcompany['CompanyName'] ?> ">
                                        ...
                                        <td><input type="hidden" name="TotalPIVat[<?=$resultcompany['VendorId']. $resultfacept['Itemid'] ?>]" value="<?= $resultfacept['TotalPIVat'] ?> "><?= number_format($resultfacept['TotalPIVat'], 2) ?></td>
                                         <td>
                                        <input type="text" class="form-control" id="marks" name="marks[<?= $resultcompany['VendorId'].$resultfacept['Itemid'] ?>]">
                ...
                <div class="row mb-3">  
                    <div class="col-sm-12">
                        <textarea id="Approval" name="Approval" rows="6" style="width: 100%; border: 1px solid #ccc;"></textarea>
