<main id="main" class="main">
    <div class="pagetitle">
        ...
        <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open('Reports/tenderReports') ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('Reports/tenderReports') ?>">
                            Reset
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"></h5>
            <!-- Table Variants -->
            <table class="table table-striped table-hover" id="TenderTable">
                <thead style="text-align: center; vertical-align: middle; border-bottom: 2px solid #001a66; border-top:  2px solid #001a66">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="col" >TEC Report</th>
                        <th scope="col" class="col" >PC Report</th>
                    </tr>
                </thead>
                <tbody  style="vertical-align: middle;">
                    ...
                    foreach ($list as $key => $result) {
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" href="<?= site_url('Reports/TECReport/' . $result['Tenderid']) ?>">TEC Report</a></td>
                            <td><a class="btn btn-primary btn-sm" href="<?= site_url('Reports/PCAReport/' . $result['Tenderid']) ?>">PC Report</a></td>
