                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-warning" href="<?= site_url('Invitation/add/' . $result['id']) ?>">Add Item</a></td>
                                         <?php } ?>
                                        <td><a class="btn btn-success"  href="<?= site_url('Invitation/view/' . $result['id']) ?>">View Item</a></td>
