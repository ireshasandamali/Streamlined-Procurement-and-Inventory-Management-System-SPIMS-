<main id="main" class="main">
    <div class="pagetitle">
        ...
        <div class="card" style="margin-top: 10px;"> 
            ...
            <!-- Multi Columns Form -->
                        <?= form_open('bidAnnounce/shoppingview') ?>
                        <div class="row g-3">  
                            <div class="col-md-1">
                            ...
                            <div class="col-md-2">
                                <input style="border-radius: 40px;border: 1px solid  #000066" type="date" class="form-control" id="BStart" name="BStart" placeholder="Bid Start Date" >                           
                            </div>
                            <div class="col-md-2">
                                <input style="border-radius: 40px;border: 1px solid  #000066"type="datetime-local" class="form-control" id="BOpen" name="BOpen" placeholder="Bid Open" >                           
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('bidAnnounce/view') ?>">
                                    Reset
                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $result['BOpens'] ?></td>
                                        <td><a href="<?= site_url('Invitation/shoppingadd/' . $result['ids']) ?>"><button class="btn btn-warning">Add Item</button></a></td>
                                        <td><a href="<?= site_url('Invitation/sview/' . $result['ids']) ?>"><button type="button" class="btn btn-success" style="color: black;">View Item</button></a></td>
...
<script>
    function changeEntries(entries) {
        // Get all table rows
        var rows = document.querySelectorAll('#AnnounceTable tbody tr');
