                    ...
                    <div class="row justify-content-center">
                        <div class="d-flex justify-content-center py-4">
                            <a href="index.html" class="logo d-flex align-items-center w-auto">
                                ...
                                <span class="d-none d-lg-block" style="text-align:center">Streamlined Procurement and Inventory Management System <br> (SPIMS)</span>                           
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        rememberCheckbox.addEventListener('change', function () {
            if (this.checked) {
                alert('Remember Me: Save your password in Google Drive!');
                // Alternatively, you can display a custom message or perform other actions.
            }
        });
    });
</script>
