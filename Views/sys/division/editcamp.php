    ...
    <section class="section dashboard">        
         <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <?= form_open('division/update') ?>

                    <div class="row mb-4">
                    <div class="row mb-3">
                        <label for="CNo" class="col-sm-2 col-form-label">Camp Number</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="CNo" name="CNo" value="<?= set_value('CNo',$camp['CNo']) ?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="CName" name="CName" value="<?= set_value('CName',$camp['CName']) ?>">
                            <span class="text-danger"><?= service('validation')->getError('CName') ?></span>
                        </div>
                    </div>
                   
                     <div class="text-center">
                           <input type="hidden" class="form-control" id="id" name="id" value="<?= set_value('id',$camp['id']) ?>">
