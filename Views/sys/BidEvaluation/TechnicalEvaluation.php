<main id="main" class="main">
    <div class="pagetitle">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" id="PreliminaryTab" data-bs-toggle="tab" href="#openedPreContent">Technical Evaluation  </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="openingTETab" data-bs-toggle="tab" href="#openingTEcContent">Technical Evaluation  Results </a>
            </li>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <!-- Accepted bidder -->
                  ...
                  <h3 style="text-align: center">Accepted Bidders</h3><hr>
                ...
                <!-- my reject bidder -->
                <h3 style="text-align: center">Rejected Bidders</h3><hr>
                <table class="table table-sm table-striped table-coler-#b3d9ff table-bordered">
                    <thead>
                        <tr>
                            <th>Item Name</th>
