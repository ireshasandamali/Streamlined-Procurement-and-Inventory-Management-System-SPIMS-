    ...
    <section class="section dashboard">        
         <div class="card" style="margin-top: 10px;"> 
            ...
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <?= form_open_multipart('BidEvaluation/TECMeetingfinacial') ?>
                            ...
                            <tbody>
                                ...
                                foreach ($listC as $key => $resultC) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" type="button" href="<?= site_url('BidEvaluation/FinancialEvaluation/'.$resultC['PNumber']) ?>"style="color: white;">Open</a></td>                                                       
                                    </tr>
                                    <?php
                                    $i++;
                                }
