<main id="main" class="main">
                ...
                <table class="table" id="ItemTable">
                    <thead>
                        <tr>
                            ...
                            <?php if ((session()->get('UserType')) == 'InventoryOfficer') { ?>
                        ...
                        foreach ($list as $key => $result) {
                            ...
                            <tr>
                                ...
                                <td>
                                            ...
                                            if($result['Status']==1){   
                                            ?>
                                           <a class="btn btn-info btn-sm" href="<?= site_url('inventory/changestatus/' . $result['id'].'/0') ?>">Processing</a>
                                            <?php
                                                
                                            } else {   
                                             ?>
                                            
                                            <a class="btn btn-danger btn-sm" href="<?= site_url('inventory/changestatus/' . $result['id'].'/1') ?>">Issued</a>
                                            <?php
                                            }
                                            ?>
                                        </td>
                                        <td>  <td><a class="btn btn-success btn-sm" href="<?= site_url('inventory/viewmore/'.$result['Itemid']) ?>">View More</a></td></tr>   </td>
 ...
 <?php
                        $i = 1;
                        foreach ($Item_List as $key => $resultItem) {
                            ?>
                            <tr>
                                <td><?= $resultItem['Balanace'] ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
