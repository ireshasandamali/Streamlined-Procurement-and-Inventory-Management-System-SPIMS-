                                ...
                                <table class="table table-borderless datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Balance Percentage</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        foreach ($listP as $key => $resultP) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-success" style="color: black;" href="<?= site_url('ProcurementItem/viewItem/'.$resultP['PId']) ?>">View Item</a></td>
                                                <td style="text-align: right">
                                                    <span class="badge <?= $resultP['percentage'] > 50 ? 'bg-success' : ($resultP['percentage'] < 20 ? 'bg-danger' : 'bg-warning') ?>"><?= $resultP['percentage'] ?>%</span>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
