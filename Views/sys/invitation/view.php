                ...
                <h5 class="card-title"></h5>                           
                        ...
                        <?= form_open('invitation/view') ?>  
                         <div class="row g-3">                              
                                    ...
                                    <div class="col-md-2">
                                          <input type="text" class="form-control" id="BSecurity" placeholder="Bid Security" name="BSecurity"> 
                        ...
                        foreach ($lista as $key => $resulta) {
                            ?>
                                   <div class="col-md-2">
                                       <a style="border-radius: 40px;border: 1px solid  #000066" type="reset" class="btn btn-secondary"href="<?= site_url('invitation/view/'.$resulta['id']) ?>">
                                    Reset
                       ...
                       <?php
                        ...
                        foreach ($lista as $key => $resulta) {
                            ...
                            <tr>
                                ...
                                <td><?= $resulta['BStart'] ?> To <?= $resulta['BEnd'] ?></td>
                            </tr>
                            <tr>
                            ...
                            <tbody>
                                ...
                                foreach ($list as $key => $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= number_format($result['DCharges'],2) ?></td>
                                        <td><?= number_format($result['BSecurity'],2) ?></td>
