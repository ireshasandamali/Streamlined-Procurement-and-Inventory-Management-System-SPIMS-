        ...
        <div class="row">
            ...
            <div class="card col-md-6" style="border: 2px solid #CCCCFF;width: 50%;">     
                <div class="card-body">
                    ...
                    <div class="row mb-3"> 
                        <label for="ICategory" class="col-sm-6 col-form-label">Item Category</label>
                        ...
                        echo 'selected';
                    } ?> >Furniture and Office Equipment - 2102</option>
                            <option value="PlantMachineryEquipment" <?php if (set_value('ICategory') == 'PlantMachineryEquipment') {
                        echo 'selected';
                    } ?> >Plant & Machinery and Equipment  - 2103</option>
                            <option value="UNMission" <?php if (set_value('ICategory') == 'UNMission') {
                        echo 'selected';
                    } ?> >UN Peace Keeping Mission  - 2509</option>
                        </select>
                        <span class="text-danger"><?= service('validation')->getError('ICategory') ?></span>

                    </div>
                    <div class="row mb-3">
                        <label for="Purpose" class="col-sm-6 col-form-label">Purpose of request</label>

                        <textarea  class="form-control col-sm-10" id="Purpose" name="Purpose" placeholder="Toners for Photocopy machine"></textarea>
                    ...
                    <div class="row mb-3"> 
                        ...
                        <label for="ReqDate" class="col-sm-6 col-form-label">Request Date</label>

                        <input type="date" class="form-control col-sm-6 " id="ReqDate" name="ReqDate">
                    ...
                    <div class="text-center">
                        <button name="action" value="add" type="submit" class="btn btn-outline-primary rounded">Add Item</button>
                        <button name="action" value="save" type="save" class="btn btn-outline-primary rounded">Cancel</button>
                    </div>
            ...
            <div class="card col-md-6" style="border: 2px solid #CCCCFF;width: 50%;">
                <div class="card-body">
                    <h2 class="card-title lead" style="text-align:center">Add Items</h2>
                    <hr style="height: 3px; background-color: red;">
                    <span class="text-success"><?= @$msg ?></span>
                    <div class="row mb-3">
                        <label for="Item" class="col-sm-7 col-form-label">Request Item</label>
                        <label for="Qty" class="col-sm-3 col-form-label">Quantity</label>
                        <label for="" class="col-sm-2 control-label"> </label>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-7">
                            <input type="text" class="form-control col-sm-7" id="Item" name="Item">
                            <span class="text-danger"><?= service('validation')->getError('Item') ?></span>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control col-sm-3" id="Qty" name="Qty">
                            <span class="text-danger"><?= service('validation')->getError('Qty') ?></span>
                        </div>


                        <div class="col-sm-2">
                            <button class="btn btn-primary add_new_item"> <i class="bi bi-plus-square" aria-hidden="true"></i> <a href="<?= site_url('vote/add') ?>" style="color: black;"></a></button>
                        </div>
                    </div>
